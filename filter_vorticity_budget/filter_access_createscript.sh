...
cat > /g/data/v46/fm6730/script_access_s2/vorticity/filter_vorticity_budget/filter_s2s_vorticity_budget_${wave}_${e}.sh << EOF
...
SCRIPT=/g/data/v46/fm6730/script_access_s2/vorticity/main_filter_vorticity_budget_${wave}.sh
echo \$INPUTS
cat \${INPUTS}
...
chmod +x /g/data/v46/fm6730/script_access_s2/vorticity/filter_vorticity_budget/filter_s2s_vorticity_budget_${wave}_${e}.sh
