...
INPUTS=/g/data/v46/fm6730/script_access_s2/vorticity/dataprep/e01_dates.txt

SCRIPT=/g/data/v46/fm6730/script_access_s2/vorticity/main_filter_vorticity_budget_mjo.sh
echo $INPUTS
cat ${INPUTS}
