...
SCRIPT='/g/data/v46/fm6730/script_access_s2/vorticity/composite/lifecycle_randmember_vorticity_budget.py'
INPUTS='/g/data/v46/fm6730/script_access_s2/vorticity/composite/input_composite_vorticity_rand.txt'
...
parallel --verbose --colsep ' ' -j ${PARALLEL_JOBS} python ${SCRIPT} {1} {2} {3} :::: ${INPUTS}
...
#                 # python /g/data/v46/fm6730/script_access_s2/hovmuller/map_lifecycle_everymember.py "$var" "$mode" "$ens"
#                 python /g/data/v46/fm6730/script_access_s2/vimfc/hovmuller_lifecycle_everymember_vimfc.py "$var" "$mode" "$ens" "$wave"
#             done
#         done
#     done
# done
