...
SCRIPT='/g/data/v46/fm6730/script_access_s2/vorticity/composite/hovmuller_randmember_vorticity_budget.py'
...
parallel --verbose --colsep ' ' -j ${PBS_NCPUS} python ${SCRIPT} {1} {2} {3} :::: ${INPUTS}
